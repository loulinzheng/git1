...
#
# AUTHORS:	Christophe Robert - christophe °dot° robert °at° cocoche °dot° fr
...
#
#			Script compatibility : MS PowerShell
#			Return Values :
...
#		1.6 - Corrected exception collection in existing code (22 Avr. 2016 - 22 April 2016)
#			* Permits parameter "Blacklist" to blacklist controller status results
#			* Auto-detects the location of HPACUCLI
#			@ DGB 2016-04-22 
#
####
...
Function Get-Errors ($buffer){
	...
	# For each physicaldrive found, check errors
	...
	{				
		...
		elseif ($element -like "*Predictive Failure*")
		{
			#Write-Host $element
			$errors.Item("CRITICAL") += $element
		}
...
{
	$global:ToSend = $_.Exception.Message
    $global:Unknown += 1;
}
finally
{
